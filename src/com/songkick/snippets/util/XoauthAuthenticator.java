...
public class XoauthAuthenticator {
	...
	public static final class XoauthProvider extends Provider {
		public XoauthProvider() {
			...
			put("SaslClientFactory.XOAUTH",
					"com.songkick.snippets.util.XoauthSaslClientFactory");
		}
	}
	...
	public static IMAPSSLStore connectToImap(String host, int port,
		...
		props
				.put(XoauthSaslClientFactory.OAUTH_TOKEN_SECRET_PROP, oauthTokenSecret);
	...
	public static SMTPTransport connectToSmtp(String host, int port,
		...
		byte[] saslResponse = builder.buildResponse(userEmail, XoauthProtocol.SMTP,
				oauthToken, oauthTokenSecret, consumer);
